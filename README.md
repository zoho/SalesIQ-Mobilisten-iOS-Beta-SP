...
[![Version](https://img.shields.io/badge/version-5.4.2-alpha-blue.svg)](https://cocoapods.org/pods/Mobilisten)

# Swift Package for SalesIQ Mobilisten Beta iOS SDK
...
2. Add `https://github.com/zoho/Mobilisten-iOS-Beta` as the package repository and click on **Next**.
